...
# Here we haven't change ANY of the code outside of
# inside of the block/method. We simply took the contents
# of the block from the previous exercise and moved it
