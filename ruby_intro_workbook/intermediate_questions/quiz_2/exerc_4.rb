...
# will have you scratching your head over the
# absence of any "word iterator" methods.

# Our natural inclination is to think of the words in a
# sentence as a collection. We would like to be able to
# operate on those words the same way we operate on the elements
...
# use the String#split in conjunction with Array#join
