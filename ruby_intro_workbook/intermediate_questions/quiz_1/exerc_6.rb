...
# Is there a difference between the two, other than what
...
# solution: rolling_buffer1 modifies the original buffer array.
# rolling_buffer2 does not modify the array coming as an argument,
# it only uses it and gets added to a new variable (or new array).